...
public class ManiaProperties {
    ...
    private Map<Integer, Color> collumnColors;
    private Map<Integer, Color> collumnLight;
    private Color colourHold;
    private Color colourBreak;
    private Color colourColumnLine;
    private Color colourBarline;
    private Color colourJudgementLine;
    private Color colourKeyWarning;
